  ...
  <section class="px-6 py-16 text-white">
    <div class="max-w-7xl mx-auto">
      <div class="flex items-end justify-between gap-4 mb-8">
        ...
        <span v-if="parties" class="text-white/60 text-sm">
          {{ parties.affiliations.length }} partijen
        </span>
      </div>

      <!-- Loading skeleton -->
      <div v-if="!parties" class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
      ...
      <div v-else class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        <article v-for="aff in parties.affiliations" :key="aff.name"
          ...
          <div class="flex items-center gap-4">
            ...
            5a1 1 0 010 1.414l-5 5a1 1 0 11-1.414-1.414L13.586 11H4a1 1 0
