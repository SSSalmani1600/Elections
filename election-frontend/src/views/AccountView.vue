        ...
        <div class="bg-[#111830]/80 border border-white/10 rounded-2xl shadow-xl overflow-hidden lg:sticky lg:top-8">
          ...
          <div v-if="!editMode">
            ...
            <div class="p-6 space-y-4">
              ...
              <button @click="startEdit" class="w-full mt-4 px-5 py-3 rounded-xl font-semibold bg-gradient-to-r from-[#ef3054] to-[#d82f4c] text-white
          ...
          <div v-else class="p-6">
            ...
            <form @submit.prevent="saveChanges" class="space-y-4">
              ...
              <div class="p-4 rounded-xl bg-amber-500/10 border border-amber-500/30">
                ...
                <input v-model="currentPassword" type="password" required placeholder="Je huidige wachtwoord"
              ...
              <div>
                ...
                <input v-model="editUser.username" type="text" required
              ...
              <div>
                <label class="text-xs font-medium text-gray-400 mb-1 block">Nieuw wachtwoord <span
                    class="text-gray-600">(optioneel)</span></label>
                <input v-model="editUser.newPassword" type="password" placeholder="Minimaal 8 karakters" minlength="8"
              ...
              <div v-if="error" class="p-3 rounded-lg bg-red-500/10 border border-red-500/30 text-red-200 text-sm">{{
                error }}</div>
              <div v-if="success"
        ...
        <div class="space-y-6">
          ...
          <div class="bg-[#111830]/80 border border-white/10 rounded-2xl shadow-xl overflow-hidden">
            ...
            <div class="p-4 max-h-[280px] overflow-y-auto">
              ...
              <div v-else-if="activity.topics.length === 0" class="text-center py-6 text-gray-500 text-sm italic">Nog
                geen topics geplaatst</div>
              <div v-else class="space-y-2">
                <router-link v-for="topic in activity.topics" :key="topic.id" :to="`/discussions/${topic.id}`"
          ...
          <div class="bg-[#111830]/80 border border-white/10 rounded-2xl shadow-xl overflow-hidden">
            ...
            <div class="p-4 max-h-[280px] overflow-y-auto">
              <div v-if="activityLoading" class="text-center py-6 text-gray-500 text-sm">Laden...</div>
              <div v-else-if="activity.reactions.length === 0" class="text-center py-6 text-gray-500 text-sm italic">Nog
                geen reacties geplaatst</div>
              <div v-else class="space-y-2">
                <router-link v-for="reaction in activity.reactions" :key="reaction.id"
