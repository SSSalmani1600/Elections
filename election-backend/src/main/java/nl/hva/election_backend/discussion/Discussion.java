...
public final class Discussion {
    ...
    private Discussion(String id, String title, String author, String body,
        ...
        if (lastActivityAt.isBefore(createdAt)) throw new IllegalArgumentException("lastActivityAt < createdAt");
    ...
    /** Kopie met nieuwe activiteit */
    public Discussion withActivity(Instant lastActivityAt, int reactionsCount) {
        return new Discussion(id, title, author, body, createdAt, Objects.requireNonNull(lastActivityAt), Math.max(0, reactionsCount));
    }
    ...
    @Override public boolean equals(Object o) { return this == o || (o instanceof Discussion d && id.equals(d.id)); }
    @Override public int hashCode() { return id.hashCode(); }
    @Override public String toString() { return "Discussion{id='%s', title='%s'}".formatted(id, title); }
}
